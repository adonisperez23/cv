<template>
  <div class="col">
    ...
    <ul>
      <li>Curso: Fundamentos de Base de Datos</li>
    </ul>
    <ul>
      <li>Curso: Curso de Algoritmos con C</li>
    </ul>
    <ul>
      <li>Curso: Curso de Desarrollo Web Online</li>
    </ul>
    <ul>
      <li>Curso: Fundamentos de JavaScript</li>
    </ul>
